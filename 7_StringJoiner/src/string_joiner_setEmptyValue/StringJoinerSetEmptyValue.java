package string_joiner_setEmptyValue;

import java.util.StringJoiner;

public class StringJoinerSetEmptyValue {
	public static void main(String[] args) {  
        ...
        /*It sets the sequence of characters to be used when determining the string representation of this 
