package java_Type_And_Repeating_Annotations;
...
The value of the @Repeatable meta-annotation, in parentheses,
is the type of the container annotation that the Java compiler generates to store repeating annotations. 
In the following example, the containing annotation type is Games. 
So, repeating @Game annotations is stored in an @Games annotation.
*/
...
/*Note - Compiler will throw a compile-time error, 
if you apply the same annotation to a declaration without first declaring it as repeatable.*/
...
public class JavaTypeAndRepeatingAnnotations {
	public static void main(String[] args) {  
	// Getting annotation by type into an array  
    Game[] game = JavaTypeAndRepeatingAnnotations.class.getAnnotationsByType(Game.class);  
